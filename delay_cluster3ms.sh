...
tc filter add dev ens18 protocol ip parent 1: prio 2 u32 match ip dst 10.139.40.106 flowid 1:2
...
tc filter add dev ens18 protocol ip parent 1: prio 1 u32 match ip dst 10.139.40.115 flowid 1:1
tc filter add dev ens18 protocol ip parent 1: prio 1 u32 match ip dst 10.139.40.116 flowid 1:1
tc filter add dev ens18 protocol ip parent 1: prio 1 u32 match ip dst 10.139.40.117 flowid 1:1
tc filter add dev ens18 protocol ip parent 1: prio 1 u32 match ip dst 10.139.40.118 flowid 1:1
tc filter add dev ens18 protocol ip parent 1: prio 1 u32 match ip dst 10.139.40.119 flowid 1:1
tc filter add dev ens18 protocol ip parent 1: prio 1 u32 match ip dst 10.139.40.120 flowid 1:1
tc filter add dev ens18 protocol ip parent 1: prio 1 u32 match ip dst 10.139.40.121 flowid 1:1
tc filter add dev ens18 protocol ip parent 1: prio 1 u32 match ip dst 10.139.40.122 flowid 1:1
tc filter add dev ens18 protocol ip parent 1: prio 1 u32 match ip dst 10.139.40.123 flowid 1:1
tc filter add dev ens18 protocol ip parent 1: prio 1 u32 match ip dst 10.139.40.124 flowid 1:1
tc filter add dev ens18 protocol ip parent 1: prio 1 u32 match ip dst 10.139.40.125 flowid 1:1
tc filter add dev ens18 protocol ip parent 1: prio 1 u32 match ip dst 10.139.40.126 flowid 1:1
tc filter add dev ens18 protocol ip parent 1: prio 1 u32 match ip dst 10.139.40.127 flowid 1:1
tc filter add dev ens18 protocol ip parent 1: prio 1 u32 match ip dst 10.139.40.128 flowid 1:1
tc filter add dev ens18 protocol ip parent 1: prio 1 u32 match ip dst 10.139.40.129 flowid 1:1
tc filter add dev ens18 protocol ip parent 1: prio 1 u32 match ip dst 10.139.40.130 flowid 1:1


tc qdisc add dev ens18 parent 1:1 handle 10: netem delay 2ms
tc qdisc add dev ens18 parent 1:2 handle 20: netem delay 0ms
tc qdisc add dev ens18 parent 1:3 handle 30: netem delay 4ms
